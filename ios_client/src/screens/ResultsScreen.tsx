...
const SHARE_LINK = 'https://quizza-eta.vercel.app/share';
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Trigger on: 60%+ score after at least 2 games, or every 5th game if score > 0
        const shouldPrompt = (isGreatGame && games >= 2) || (games % 5 === 0 && pct > 0);
